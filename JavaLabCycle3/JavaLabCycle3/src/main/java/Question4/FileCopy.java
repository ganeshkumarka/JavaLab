...
public class FileCopy {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.print("Enter the source file name (without path): ");
            String sourceFileName = reader.readLine();

            // Get the target file name
            System.out.print("Enter the target file name (without path): ");
            String targetFileName = reader.readLine();

            // Construct the full file paths based on the package structure
            String sourceFilePath = "C:\\Users\\ganesh\\OneDrive\\Desktop\\q4\\" + sourceFileName;
            
            String targetFilePath = "C:\\Users\\ganesh\\OneDrive\\Desktop\\q4\\" + targetFileName;
